        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header header-elements-inline">
                    ...
                    @else
                        <h5 class="card-title">Update Profesi</h5>
                    @endif
                        ...
                        <form action="#">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-6 col-form-label">Profesi:</label>
                                    <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <table class="table datatable-basic table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($dataprofesis as $key => $value)
                            <tr>
                                <td>{{ $loop->index + $dataprofesis->firstItem() }}</td>
                                <td>{{ $value->nama }}</td>
                                <td>
                ...
                <div class="container mb-2">
                    {{ $dataprofesis->links('livewire::bootstrap') }}
                </div>
            </div>
        </div>
    </div>
