<div>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header header-elements-inline">
                    @if ($updatedata == false)
                        <h5 class="card-title">Tambah Golongan Darah</h5>
                    @else
                        <h5 class="card-title">Update Golongan Darah</h5>
                    @endif
                        ...
                        <form action="#">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-6 col-form-label">Golongan Darah:</label>
                                    <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Daftar Golongan Darah</h5>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ml-3">
                ...
                <table class="table datatable-basic table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($golongan_darahs as $value)
                            <tr>
                                <td>{{ $loop->index + $golongan_darahs->firstItem() }}</td>
                                <td>{{ $value->nama }}</td>
                                <td>
                ...
                <div class="container mb-2">
                    {{ $golongan_darahs->links('livewire::bootstrap') }}
                </div>
            </div>
        </div>
    </div>
